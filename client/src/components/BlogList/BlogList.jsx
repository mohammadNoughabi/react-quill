...
const BlogList = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      console.log(error);
      alert("Deleting blog failed: " + (error.response?.data?.message || error.message));
    } finally {
      setDeletingId(null);
    }
  };
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Dive into our collection of insightful articles, stories, and expert perspectives
          </p>
        </div>
        ...
        {blogs.length > 0 && (
          <div className="text-center mt-12 pt-8 border-t border-gray-200/50">
            <p className="text-gray-500 text-sm">
              ...
              Sorted by {sortBy.replace('newest', 'newest first').replace('oldest', 'oldest first')}
            </p>
          </div>
        )}
      </div>
